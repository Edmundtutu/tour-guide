            ...
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <h1 class="display-5 mb-0">
                        <i class="fas fa-edit me-3 text-primary"></i>Edit Hotel
                    </h1>
            ...
            <div class="col-lg-8">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <form action="<?= BASE_URL ?>/host/edit-hotel?id=<?= htmlspecialchars($hotel['id']) ?>" method="POST" id="edit-hotel-form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="url" 
                                           ...
                                           id="image_url" 
                                           name="image_url"
                                           value="<?= htmlspecialchars($hotel['image_url'] ?? '') ?>"
